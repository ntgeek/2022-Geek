...
+ **[21级必做/22级学有余力-进阶]** 结合三件套（HTML+CSS+JavaScript）在浏览器上的执行逻辑，重新思考markdown的原理，写下你的新体验
+ **[21级必做/22级学有余力-进阶]** 关注typora的主题更换方式，尝试自己DIY一个
...
4. ⽂件操作
5.  **[21级必做/22级学有余力-进阶]** 学会使用Python解释器
6.  **[21级必做/22级学有余力-进阶]** 了解一些内置函数及类型的实现，说不定能获得新的感悟
...
4.  **[21级必做/22级学有余力-进阶]** 找到python更多的应用领域并做出demo（例如excel处理、系统文件操作脚本等）
