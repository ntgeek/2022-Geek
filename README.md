...
3.[可选] 如果可以, 我们在当前仓库的`main`分支下留有一个名为`git-idea`的文件夹, 你们可以将你们的git学习感想(记得带上自己的名字)放进来,并向我们提出PR,我们欢迎大家这样做, 虽然会有一点小难度.(你可以从中学会分支合并等操作)
4.[可选]我们准备了一个`surprise`分支, 欢迎大家来争夺排行榜(你可以从中学会如何产生冲突及解决)
