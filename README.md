...
5. **[21级必做/22级学有余力-进阶]** 探索typora的更多功能，能够发现什么？
...
+ **[21级必做/22级学有余力-进阶]** 结合三件套在浏览器上的执行逻辑，重新思考markdown的原理，是否有新的体悟？
+ **[21级必做/22级学有余力-进阶]** 关注typora的主题更换方式，能不能自己diy玩一下？
...
4. [学有余力-进阶]找到python更多的应用领域并做出demo（例如excel处理、系统文件操作脚本等）
